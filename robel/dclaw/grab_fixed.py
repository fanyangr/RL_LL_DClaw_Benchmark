...
RESET_POSE = [0.5] + [0, -np.pi / 3, np.pi / 3] * 3
...
class BaseDClawTurn(BaseDClawObjectEnv, metaclass=abc.ABCMeta):
    ...
    def get_obs_dict(self) -> Dict[str, np.ndarray]:
        ...
        object_error = base_pos[2] - object_state.qpos[2]
        object_error -= 0.15 # guarantee that the base is not too close to the object
    ...
    def get_reward_dict(
        ...
        reward_dict = collections.OrderedDict((
            ...
            ('bonus_small', 10 * (target_dist < 0.07)),
