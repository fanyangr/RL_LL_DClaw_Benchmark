...
class BaseDClawTurn(BaseDClawObjectEnv, metaclass=abc.ABCMeta):
    ...
    def get_obs_dict(self) -> Dict[str, np.ndarray]:
        ...
        object_error = base_pos - object_state.qpos[:3]
        object_error[2] -= 0.15 # guarantee that the base is not too close to the object
        ...
        target_error = object_state.qpos[2] - self._target_object_pos
        if target_error > 0:
            target_error = 0
    ...
    def get_reward_dict(
        ...
        object_qpos = obs_dict['object_qpos']
        ...
        reward_dict = collections.OrderedDict((
            ...
            ('bonus_small', 10 * (target_dist < 0.1)),
